        ...
        implements View.OnClickListener
{
  ...
  public void onCreate(Bundle savedInstanceState)
  {
    ...
    mHeaderSilent = _add_static_view(("silent"), null);
    if (existing_uri != null) {
      mHeaderExisting = _add_static_view(("Existing"), existing_uri);
    }
    if (default_uri != null) {
      mHeaderDefault = _add_static_view(("Default"), default_uri);
    }
    View v = mInflater.inflate(R.layout.tonepicker_footer,null);
    mFooterOthers = (TextView)v.findViewById(android.R.id.text1);
    mFooterOthers.setText("other apps");
